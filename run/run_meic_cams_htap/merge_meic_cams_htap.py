...
def run(year, months, model_grid, mechanism_name):
    """
    ...
    print('---------------------------------')
    #Set directories
    dir_meic1 = os.path.join(r'G:\test', mechanism_name, r'MEIC', str(year))
    dir_cams1 = os.path.join(r'G:\test', mechanism_name, r'CAMS', str(year))
    dir_htap1 = os.path.join(r'G:\test', mechanism_name, r'HTAP\2010')
    dir_out1 = os.path.join(r'G:\test', mechanism_name, r'merge', str(year))
