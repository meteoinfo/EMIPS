...
def run_meic(year, months, model_grid, mechanism_name, mechanism):
    """
    ...
    for month in months:
        ...
        dir_inter = os.path.join(r'G:\test_data', mechanism_name, r'region_0.15\MEIC\{0:}\{0:}{1:>02d}'.format(year, month))
