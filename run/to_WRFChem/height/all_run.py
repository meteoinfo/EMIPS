'''
Merge files, convert pollutants and projection to meet WRF-Chem's input requirements(with height assignment).
'''
...
#set model grid and target grid
...
height.run_allocate(year, month, dir_inter, model_grid, sectors, zdim)
print('Merge data from different sectors...')
merge.run_merge(year, month, dir_inter, model_grid, sectors, zdim)
print('Distribution of particulate matter and change unit...')
transform.run_transform(year, month, dir_inter, model_grid, out_species, out_species_aer, zdim)
