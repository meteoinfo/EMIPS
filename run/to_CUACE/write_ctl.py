'''
Write the description file of the output binary data file.
'''
import calendar

year = 2016
ddir = r'N:\Emis_model\GRAPES_CUACE\global_1'
types = ['low','poi','pow','air']
for month in [11]:
    tdir = os.path.join(ddir, str(year)+'_tw', '{}{:>02d}'.format(year, month))
    for tps in types:
