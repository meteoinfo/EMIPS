...
def run(year, month, dir_inter, model_grid, target_grid, out_species, out_species_aer, global_attributes, mechanism_name, z):
    """
    ...
    fn_out = dir_inter + '\wrfchemi_d01_{}_{:0>2d}_{}'.format(year, month, mechanism_name)
